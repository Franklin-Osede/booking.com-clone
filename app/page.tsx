  ...
  return (
    <main className="bg-[#013B94]">
      <section className='max-w-7xl mx-auto p-6'>
        <h2 className='font-bold text text-5xl text-white'>   Find your Next Stay  </h2>
    ...
    <div className='pt-5'>
      ...
      <p className='font-light'>Most Popular choices for travellers from around the world 
      </p>
      </div>
